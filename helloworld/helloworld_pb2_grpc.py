...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sumaDiasFecha = channel.unary_unary(
                ...
                request_serializer=helloworld__pb2.SumaFecha.SerializeToString,
                response_deserializer=helloworld__pb2.Fecha.FromString,
                _registered_method=True)
        self.dimeCentroDiana = channel.unary_unary(
                '/helloworld.Greeter/dimeCentroDiana',
                request_serializer=helloworld__pb2.Vacio.SerializeToString,
                response_deserializer=helloworld__pb2.Centro.FromString,
                _registered_method=True)
        self.disparaCannon = channel.unary_unary(
                '/helloworld.Greeter/disparaCannon',
                request_serializer=helloworld__pb2.Disparo.SerializeToString,
                response_deserializer=helloworld__pb2.Tiro.FromString,
                _registered_method=True)
        self.mejorDisparo = channel.unary_unary(
                '/helloworld.Greeter/mejorDisparo',
                request_serializer=helloworld__pb2.Vacio.SerializeToString,
                response_deserializer=helloworld__pb2.Mejor.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sumaDiasFecha': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=helloworld__pb2.SumaFecha.FromString,
                    response_serializer=helloworld__pb2.Fecha.SerializeToString,
            ),
            'dimeCentroDiana': grpc.unary_unary_rpc_method_handler(
                    servicer.dimeCentroDiana,
                    request_deserializer=helloworld__pb2.Vacio.FromString,
                    response_serializer=helloworld__pb2.Centro.SerializeToString,
            ),
            'disparaCannon': grpc.unary_unary_rpc_method_handler(
                    servicer.disparaCannon,
                    request_deserializer=helloworld__pb2.Disparo.FromString,
                    response_serializer=helloworld__pb2.Tiro.SerializeToString,
            ),
            'mejorDisparo': grpc.unary_unary_rpc_method_handler(
                    servicer.mejorDisparo,
                    request_deserializer=helloworld__pb2.Vacio.FromString,
                    response_serializer=helloworld__pb2.Mejor.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def sumaDiasFecha(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/helloworld.Greeter/sumaDiasFecha',
            helloworld__pb2.SumaFecha.SerializeToString,
            helloworld__pb2.Fecha.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def dimeCentroDiana(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/helloworld.Greeter/dimeCentroDiana',
            helloworld__pb2.Vacio.SerializeToString,
            helloworld__pb2.Centro.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def disparaCannon(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/helloworld.Greeter/disparaCannon',
            helloworld__pb2.Disparo.SerializeToString,
            helloworld__pb2.Tiro.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def mejorDisparo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/helloworld.Greeter/mejorDisparo',
            helloworld__pb2.Vacio.SerializeToString,
            helloworld__pb2.Mejor.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
